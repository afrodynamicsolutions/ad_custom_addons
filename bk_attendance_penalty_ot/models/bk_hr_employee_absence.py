...
class HrEmployeeAbsence(models.Model):
    ...
    other_monthly_working_hours = fields.Float(string="Monthly Working Hours", readonly=False, compute='_compute_other_monthly_working_hours')
    ...
    def _compute_other_monthly_working_hours(self):
        for record in self:
            if record.report_report_id and not record.change_working_hrs:
